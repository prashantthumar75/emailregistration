...
class UserRegisterExtra(models.Model):
...
class UserProfile(TimeStampedModel, Verification):
    """
...
#
#
# class AdminstrModel(models.Model):
#     kort = models.CharField(max_length=25, name='name')
#
#
# class Teachermodel12(models.Model):
#     teh = models.CharField(max_length=10)
#     port = models.IntegerField()
#
#
# class ClassesModel(models.Model):
#     admist = models.ForeignKey(AdminstrModel,on_delete=models.CASCADE)
#     class1 = models.IntegerField(name='Class')
#
#
# class DivModel(models.Model):
#     teachers = models.ForeignKey(Teachermodel12, on_delete=models.CASCADE)
#     nameDiv = models.CharField(choices=DIVISION_CHOISE,max_length=25)
#
#
